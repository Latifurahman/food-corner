...
const Admin = () => {
    return (
        <nav className="navbar-admin navbar-expand d-flex flex-column align-items-start" id="sidebar">
            ...
            <ul className="navbar-nav d-flex flex-column mt-5 w-100">
                ...
                <li className="nav-item w-100">
                    <a href="/manageProduct" className="nav-link text-light pl-4"><AddIcon></AddIcon> Add Product</a>
                </li>
                <li className="nav-item w-100">
                    <a href="/manageProduct" className="nav-link text-light pl-4"><EditIcon></EditIcon> Edit Product</a>
                </li>
            </ul>
        </nav>
    );
